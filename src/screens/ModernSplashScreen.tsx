...
const styles = StyleSheet.create({
  ...
  glowOne: { position: 'absolute', width: 380, height: 380, borderRadius: 190, backgroundColor: 'rgba(37,99,235,.14)', top: -130, right: -160 },
  glowTwo: { position: 'absolute', width: 320, height: 320, borderRadius: 160, backgroundColor: 'rgba(124,58,237,.12)', bottom: -130, left: -130 },
  ...
  logo: { width: 124, height: 124 }, title: { color: colors.text, fontSize: 38, fontWeight: '900', letterSpacing: -1.5, marginTop: 24 }, accent: { color: colors.cyan }, subtitle: { color: colors.muted, fontWeight: '800', fontSize: 10, letterSpacing: 2.3, marginTop: 8 },
