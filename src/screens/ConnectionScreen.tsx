...
const styles = StyleSheet.create({
  ...
  qrCard: { minHeight: 146, borderRadius: 24, backgroundColor: '#0EA5E9', padding: 20, flexDirection: 'row', alignItems: 'center', gap: 16, overflow: 'hidden', elevation: 8, shadowColor: colors.cyan, shadowOpacity: .22, shadowRadius: 18 }, qrGlow: { position: 'absolute', width: 180, height: 180, borderRadius: 90, backgroundColor: 'rgba(255,255,255,.18)', right: -70, top: -90 }, qrIcon: { width: 68, height: 68, borderRadius: 21, backgroundColor: 'rgba(3,12,28,.92)', alignItems: 'center', justifyContent: 'center' }, qrCopy: { flex: 1 }, qrTitle: { color: '#06101F', fontSize: 20, fontWeight: '900', letterSpacing: -.5 }, qrBody: { color: '#0B3B4B', fontSize: 12, lineHeight: 18, marginTop: 5, fontWeight: '600' }, recommended: { position: 'absolute', right: 12, top: 12, backgroundColor: 'rgba(3,12,28,.85)', borderRadius: radius.pill, paddingHorizontal: 9, paddingVertical: 5 }, recommendedText: { color: '#8DEBFA', fontSize: 8, fontWeight: '900', letterSpacing: .8 }, pressed: { opacity: .82, transform: [{ scale: .99 }] },
